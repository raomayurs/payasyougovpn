...
exports.areClientsConnected = exports.setupVPNServer = void 0;
const node_ssh_1 = require("node-ssh");
const ssh = new node_ssh_1.NodeSSH();
async function sshConnect(hostname, privateKey) {
    await ssh.connect({
        host: hostname,
        username: "openvpnas",
...
const setupVPNServer = async (instanceDetails) => {
    if (!instanceDetails.publicDnsName || !instanceDetails.keyPair) {
        ...
        await waitForServerToStart(instanceDetails.publicDnsName, instanceDetails.keyPair.pemData);
...
exports.setupVPNServer = setupVPNServer;
const waitForServerToStart = async (hostname, privateKey) => {
...
const areClientsConnected = async (hostname, privateKey) => {
    await sshConnect(hostname, privateKey);
...
exports.areClientsConnected = areClientsConnected;
